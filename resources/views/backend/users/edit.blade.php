...
@section('content')
    <div class="page-header">
        ...
        <p class="page-description">Edit user information and profile</p>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('backend.users.change-password', $user->id) }}" method="POST">
                        @csrf
            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="profile-upload-section">
                        ...
                        <form action="{{ route('backend.users.update-profile-picture', $user->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
